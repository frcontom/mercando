...
-- -----------------------------------------------------------
-- 5. MERCADO_PRODUCTOS (productos asignados a un mercado)
-- -----------------------------------------------------------
...
CREATE INDEX idx_mp_mercado ON mercado_productos(mercado_id);
CREATE INDEX idx_mp_tienda ON mercado_productos(tienda_id);
...
-- -----------------------------------------------------------
-- 7. VALORES POR DEFECTO (opcional)
-- -----------------------------------------------------------
